# 🚀 distribuidor-miranda - Guía del Proyecto

> **Cliente:** Distribuidor-miranda  
> **Industria:** Tu industria aquí  
> **Sitio:** distribuidor-miranda.com  
> **CMS:** dis.kinto.info (oculto)  
...
```bash
# Estás en: kinto-cms/sites/distribuidor-miranda/
...
**Distribuidor-miranda** es una empresa de Tu industria aquí que necesita:
...
{
  site: {
    domain: 'distribuidor-miranda.com',
    name: 'distribuidor-miranda',
    description: 'Sitio web de distribuidor-miranda',
    language: 'es'
  },
  cms: {
    enabled: true,
    subdomain: 'dis.kinto.info',
    hidden: true
  }
}
```
