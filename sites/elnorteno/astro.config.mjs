...
try {
  ...
  console.log(
    "✅ Skills activas:",
    activeSkills.length ? activeSkills.join(", ") : "Ninguna (core limpio)",
  );
} catch (error) {
  ...
  vite: {
    resolve: {
      alias: {
        ...
        // Alias para dependencias de skills
        minisearch: join(__dirname, "node_modules/minisearch/dist/es/index.js"),
      },
    },
    optimizeDeps: {
      include: ["minisearch"],
