...
export type { Env } from "./shopify-client";
...
function matchApiRoute(
  ...
  | { handler: "products"; segments: string[] }
  | { handler: "collections"; segments: string[] }
  | { handler: "cart"; segments: string[] }
  | { handler: "webhooks"; segments: string[] }
  | { handler: "health"; segments: string[] }
  | null {
