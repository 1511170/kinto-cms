...
export function install(context: any) {
  const scriptBase =
    "../../skills/community/image-optimizer/scripts/optimize.cjs";
  ...
  pkg.scripts["images:optimize:full"] =
    `node ${scriptBase} --update-refs --clean`;
  ...
  console.log(
    "   npm run images:optimize:full    → Convierte + actualiza refs + limpia originales",
  );
}
